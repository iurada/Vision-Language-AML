...
def parse_arguments():
    ...
    parser.add_argument('--experiment', type=str, default='baseline', choices=['baseline', 'domain_disentangle', 'clip_disentangle', 'baseline_domain_generalization', 'domain_disentangle_domain_generalization', 'clip_disentangle_domain_generalization'])
